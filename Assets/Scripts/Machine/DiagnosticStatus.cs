...
* Release data: 2018-FEb-9
* Release Version: DiagnosticStatus V1.1.0
...
public class DiagnosticStatus : MonoBehaviour {
    ...
    void MotDiagStatus()
    {
        ...
        MotStatus.MotStopBit = DynaLinkHS.MotStop;
        _tMotStopBit = MotStatus.MotStopBit;
