...
//*************************************************************************
//@header       HOGHiddenObject
//@abstract     This script handles a hidden object. When the objects are created, they all have this script. The objects which are specifically hidden also have a collider which.
...
namespace FZ.HiddenObjectGame
{
	...
	public class HOGHiddenObject:MonoBehaviour 
	{
        ...
        //This function runs when you click on it.Modify on 2017/12/25*************************************
        //IEnumerator OnMouseDown()
        IEnumerator FoundHiddenObjects()
        {
            //If this is one of the hidden objects, it is clickable
			if (isHidden == true )
			{
                //Debug.Log("<color=orange>FoundHiddenObjects!!</color>");
                //Take the object out of the hierarchy
                //transform.parent = null;

                //Update the number of found objects in the game controller
                GameObject.Find("GameController").SendMessage("UpdateFoundObjects");
